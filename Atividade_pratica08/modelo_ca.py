...
from sklearn.ensemble import RandomForestClassifier # Algoritmo Forest
...
# X_train e X_test: caracteristicas para treino e para teste
...
# Iniciailizar o conjunto Random Forest com os parâmetros.
...
y_pred_proba = modelo.predict_proba(X_test)[:, 1] # Probabilidade da classe positiva (1) benigno
...
auc = roc_auc_score(y_test, y_pred_proba) # Área sob a curva ROC (AUC)
